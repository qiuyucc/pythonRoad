...
def download():
    time.sleep(10)
    tkinter.messagebox.showinfo('Info', 'Complete Downloading')


def show_about():
    tkinter.messagebox.showinfo('Info', 'author:brook')
...
# 我们会发现，当点击“下载”按钮后整个程序的其他部分都被这个耗时间的任务阻塞而无法执行了，这显然是非常糟糕的用户体验